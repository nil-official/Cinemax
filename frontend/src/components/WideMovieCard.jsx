...
import { Card, CardActionArea, CardContent, CardMedia, Typography, Box, Chip, useMediaQuery } from '@mui/material';
...
const WideMovieCard = ({ movie }) => {
  ...
  return (
    <Card sx={{ position: 'relative', overflow: 'hidden', borderRadius: '8px', marginBottom: '16px'}}>
      ...
      >
        ...
        <Typography variant='h4' sx={{ color: '#fff', fontWeight: 'bold', fontSize: { xs: '1.5rem', sm: '2rem', md: '2.5rem' } }}>
          {movie.title}
        </Typography>

          {/* <Typography variant="body2" sx={{ color: '#fff', marginTop: '8px' }}> */}
            <Chip label={movie.genre} size="small" sx={{ marginRight: '8px' }} />
          {/* </Typography> */}
      </Box>
    </Card>
  );
